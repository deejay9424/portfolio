export default () => ({
    ...
    user: {
        ...
        firstName: 'Dhruv',
        lastName: 'Jain',
        bio: 'Bussiness owner turned to Software developer, Trying to follow my passion!',
        imageSrc: '/Dj.jpg',
        contactNumber: '+91-8218634252',
    ...
    title: '',
    certificatesData: [
        { color: "secondary", img: "/AI_Microsoft.jpg" },
        { color: "secondary", img: "/IoT_Internshala.jpg" },
        { color: "secondary", img: "/Js_W3C.jpg"}
    ]
})